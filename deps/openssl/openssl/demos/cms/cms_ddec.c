...
int main(int argc, char **argv)
{
    ...
    in = BIO_new_file("\x73\x6d\x65\x6e\x63\x72\x2e\x70\x65\x6d", "\x72");
    ...
    dcont = BIO_new_file("\x73\x6d\x65\x6e\x63\x72\x2e\x6f\x75\x74", "\x72\x62");

    if (!in)
        goto err;

    out = BIO_new_file("\x65\x6e\x63\x72\x6f\x75\x74\x2e\x74\x78\x74", "\x77");
    if (!out)
        goto err;
